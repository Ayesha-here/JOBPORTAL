...
const Hero = () => {
    ...
    const user = {fullName: "Aasu", role:"employer"};
        ...
        <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
                ...
                >
                 ...
                 whileHover={{scale: 1.02}}
                 whileTap={{scale: 0.98}}
                 className="bg-white border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-semibold text-lg hover:border-gray-300 transition-all duration-300 shadow-sm hover:shadow-md"
                 onClick={()=>{
                     navigate(
